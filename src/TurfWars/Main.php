...
// 	$this->getServer()->getCommandMap()->register("TW-DRAGKILLS", new TurfWarsCommand($this));
    ...
    public function updateTerrain($game, $scorerteam) {
        ...
        if ($scorerteam == "Red") {
            $lvl->setBlock(new Vector3($x, 63, 1661), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1662), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1663), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1664), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1665), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1666), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1667), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1668), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1669), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1670), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1670), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1671), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1672), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1673), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1674), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1675), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1676), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1677), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1678), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1679), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1680), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1681), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1682), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1683), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1684), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1685), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1686), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1687), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1688), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1689), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1690), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1691), Block::get(251, 14));
            $lvl->setBlock(new Vector3($x, 63, 1692), Block::get(251, 14));
        }
        if ($scorerteam == "Blue") {
            $lvl->setBlock(new Vector3($x + 1, 63, 1662), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1663), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1664), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1665), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1666), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1667), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1668), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1669), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1670), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1670), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1671), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1672), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1673), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1674), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1675), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1676), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1677), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1678), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1679), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1680), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1681), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1682), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1683), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1684), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1685), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1686), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1687), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1688), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1689), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1690), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1691), Block::get(251, 11));
            $lvl->setBlock(new Vector3($x + 1, 63, 1692), Block::get(251, 11));
        }
    }
    ...
    public function GameSetup($player, $Arena) {
        ...
        if (count($this->getServer()->getLevelByName($Arena)->getPlayers()) == 2) {
        ...
        foreach ($this->games as $game => $value) {
            ...
            if ($this->getServer()->isLevelLoaded($Arena)) {
                ...
                if ($this->games[$this->getGameByLevel($Arena) ]["Status"] == "INGAME") {
                    ...
                    if (count($this->getServer()->getLevelByName($Arena)->getPlayers()) < $this->MAX && $Status == 5) {
                        $this->StartGame($Arena);
                    }
                    if ($Status == 1) {
